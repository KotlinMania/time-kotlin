...
kotlin {
    ...
    swiftExport {
        moduleName = "Time"
        flattenPackage = "io.github.kotlinmania.time"
    }

    android {
        namespace = "io.github.kotlinmania.time"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "time-kotlin", version.toString())

    pom {
        name.set("time-kotlin")
        description.set("Kotlin Multiplatform port of time-rs/time - Date and time library. Fully interoperable with the standard library. Mostly compatible with #![no_std]")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/time-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/time-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/time-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/time-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTimeXCFramework",
    "assembleTimeDebugXCFramework",
    "assembleTimeReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTimeXCFramework",
    "assembleReleaseIosFatFrameworkForTimeXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTimeXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTimeXCFramework",
    "assembleDebugMacosFatFrameworkForTimeXCFramework",
    "assembleReleaseMacosFatFrameworkForTimeXCFramework",
    "assembleDebugTvosFatFrameworkForTimeXCFramework",
    "assembleReleaseTvosFatFrameworkForTimeXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTimeXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTimeXCFramework",
    "assembleDebugWatchosFatFrameworkForTimeXCFramework",
    "assembleReleaseWatchosFatFrameworkForTimeXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTimeXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTimeXCFramework",
