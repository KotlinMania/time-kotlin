...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Time.swiftmodule/`
...
//      `import Time` above would fail at compile time.
//
//   2. The static archive `libTime.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Time" }` and
//      `flattenPackage = "io.github.kotlinmania.time"` configuration in
...
final class TimeExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Time swift module imported cleanly")
    }
}
