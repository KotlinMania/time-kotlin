...
This file is the quick-reference operating contract for time-kotlin. The longer
...
time-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`time`](https://crates.io/crates/time). Upstream Rust is the behavioral oracle while the
